...
# MODELOS
def pdhg_opp_den_gradient(u, u_0, img_name):
    # RGB to OPP
    u_0 = rgb2opp(u_0, 0.6)
...
def run_model():
    if sys.argv[1] == 'pdhg_opp_den_gradient':
        # Change this line for the model to test
        graph_file_name, info_file_name, img_output = test_model(u, u_0, img_name, pdhg_opp_den_gradient)
