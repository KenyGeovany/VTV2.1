...
# MODELOS
def pdhg_rgb_deb_gradient(u, u_0, img_name):
    # Parameters
    std = 1.6
...
def run_model():
    if sys.argv[1] == 'pdhg_rgb_deb_gradient':
        # Change this line for the model to test
        graph_file_name, info_file_name, img_output = test_model(u, u_0, img_name, pdhg_rgb_deb_gradient)
